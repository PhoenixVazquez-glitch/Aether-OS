...
// RequestOption is an option for the requests made by the thern.1 API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/PhoenixVazquez-glitch/Aether-OS#readme-requestoptions
