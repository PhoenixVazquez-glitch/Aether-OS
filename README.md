...
<a href="https://pkg.go.dev/github.com/PhoenixVazquez-glitch/Aether-OS"><img src="https://pkg.go.dev/badge/github.com/PhoenixVazquez-glitch/Aether-OS.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/PhoenixVazquez-glitch/Aether-OS" // imported as thern1
)
```
...
```sh
go get -u 'github.com/PhoenixVazquez-glitch/Aether-OS@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/PhoenixVazquez-glitch/Aether-OS/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/PhoenixVazquez-glitch/Aether-OS/issues) with questions, bugs, or suggestions.
